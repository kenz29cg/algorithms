...
public class Point implements Comparable<Point> {
	...
	StdOut.println("P is greater than Q? " + P.compareTo(Q) );
	StdOut.println("Slope order of Q and R? " + P.slopeOrder().compare(Q,R));
	Point s = new Point(3,3);
	Point t = new Point(1,2);
	StdOut.println("sx = " + s.x);
	StdOut.println("sy = " + s.y);
	StdOut.println("tx = " + t.x);
	StdOut.println("ty = " + t.y);
	double slope = s.slopeTo(t);
	StdOut.println("s,t slope = " + slope);
